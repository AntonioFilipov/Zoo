...
class TestAnimalClass(unittest.TestCase):
    ...
    def test_animal_init(self):
        animal1 = Animal("Tiger", 13, "Toshko", "male", 30, 15*12, "meat", 3, 2, 90, 1.33, 0.25)
        ...
        self.assertEqual(animal1.life_expectancy, 15*12)
    ...
    def test_animal_grow_normalWeight(self):
        ...
        self.assertEqual(animal1.age, animal1.age + 3)
        self.assertEqual(animal1.weight, old_weight + (3 * animal1.weight_age))

    def test_animal_grow_overWeight(self):
        animal1 = Animal("Tiger", 13, "Toshko", "male", 88, 15*12, "meat", 3, 2, 90, 1.33, 0.25)
        animal1.animal_grow(3)
    ...
    def test_animal_dead(self):
        animal1 = Animal("Tiger", 13, "Toshko", "male", 180, 15*12, "meat", 3, 2, 90, 1.33, 0.25)
        self.assertTrue(animal1.animal_die())

    def test_animal_alive(self):
        animal1 = Animal("Tiger", 13, "Toshko", "male", 1, 15*12, "meat", 3, 2, 90, 1.33, 0.25)
